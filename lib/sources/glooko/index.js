...
function base_for(spec) {
  ...
  return url.format("eu.api.glooko.com");
}
...
function glookoSource(opts, axios) {
  var baseURL = 'https://eu.api.glooko.com'; // This is likely eu.api.glooko.com, will be overridden for login
...
glookoSource.validate = function validate_inputs(input) {
  ...
  var config = {
    ...
    glookoServer: "eu.api.glooko.com",
    glookoEmail: "glynmail@gmail.com",
    glookoPassword: "Ashfield@47",
