...
function createNightscoutHelper(config) {
   ...
   */
  async function fetchexistingDailyBasal(jwt) {
    var res = await axios.get(
   ...
   * @returns {Promise<{ existingSiteChanges: Array, existingAlarms: Array, existingDailyBasal: Array, fetchBaselineTotal: Function }>}
   */
  async function buildContext(options) {
    ...
    try {
      ...
      if (needsDailyTotals) {
        context.existingDailyBasal = await fetchexistingDailyBasal(jwt);
      }
    } catch (e) {
